...
> machinery starts in [Part 2](../part-2-heartbeat/README.md).
...
[agentic coding primer](../prerequisites/agentic-coding-primer.md) first. The
[glossary](../00-foundations/glossary.md) is worth keeping open in a tab.
