...
> [spec-driven primer](../prerequisites/spec-driven-primer.md) — a stop you can't
> write precisely is a goal you haven't specified yet. The doom loop and its
> cousins get a full page in [failure modes](../operating/failure-modes.md).
...
condition**, **run limit** — see the [glossary](../00-foundations/glossary.md).
