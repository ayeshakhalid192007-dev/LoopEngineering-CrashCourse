...
| "morning repo triage" | recurs | calendar | harmless | partly | scheduled L1 report ([Step 13](../part-5-complete-loop/13-build-the-loop-twice.md)) |

## Two classification mistakes to catch early

- **A workflow mistaken for a loop.** Fixed steps, one pass, deterministic order?
  That's the *body of one beat* ([Step 11](../part-3-the-body/11-maker-checker.md)),
