...
- [ ] Demotion rule: any incident → drop one level, run the [recovery playbook](../operating/recovery-playbook.md)

## The seven-item minimum before the FIRST run

The same list every loop in this repo clears
(cf. [Step 13](../part-5-complete-loop/13-build-the-loop-twice.md)):
