...
[Step 11](../part-3-the-body/11-maker-checker.md)); `tokens_estimate` feeds
[cost management](../part-6-human-control/cost-management.md); `outcome` makes the
...
The [verification ladder](../part-6-human-control/verification.md) turns that
