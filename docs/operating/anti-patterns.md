...
| **Too many overlapping tools** | "give it everything, it'll pick" | every extra tool is a loaded option for a confused beat | few, focused tools ([Step 10](../part-3-the-body/10-connectors-mcp.md)) |
...
| events assumed queued | silent gaps in bursts | [dropped-not-queued](../part-2-heartbeat/07-event-driven.md) |
...
[design checklist](../methods/loop-design-checklist.md) gets its checkmarks.*
