...
(The picker page itself: [methods/pattern-picker.md](../methods/pattern-picker.md).)
...
> and what would justify L3) is [Step 14](../part-6-human-control/14-staying-the-engineer.md)'s
...
**routine**, **human gate** — see the [glossary](../00-foundations/glossary.md).
